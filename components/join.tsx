...
function Join() {
  return (
    <div className="relative lg:px-[60px] max-h-[400px] px-6 isolate w-full h-[40vh] flex md:items-center flex-col md:flex-row gap-5  items-start justify-center md:justify-between mt-10 text-white text-center">
      <iframe
