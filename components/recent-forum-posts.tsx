...
export default function RecentForumPosts() {
  ...
  return (
    <div className="w-full relative z-20 mt-20 px-6 py-12 backdrop-blur-lg">
      <div className="mx-auto ">
        <div className="mb-8 flex items-center justify-between">
          ...
          <Button
            variant="outline"
            className="rounded-full hidden lg:flex items-center justify-center  border-white/20 bg-transparent text-white  hover:bg-transparent hover:text-white lg:px-[67px] lg:py-[22px] text-lg"
          >
            View all
          </Button>
        </div>
      ...
      <div className="aspect-square  w-full h-[300%] -top-[50%] rounded-full blur-[246px]  -z-10 mx-auto   absolute  bg-[#392058]" />
    </div>
  );
}
