...
export default function Integration() {
  return (
    <div className="w-full relative px-5">
      <div
        id="integration"
        className="lg:h-[85dvh] max-h-[850px] z-30 min-h-[450px] lg:w-[80%] w-full backdrop-blur-lg  mx-auto relative lg:px-[77px] px-5 text-white flex flex-col items-start gap-6 justify-end py-8 lg:py-[56px] bg-[#392058]/40 rounded-[14px]"
      >
